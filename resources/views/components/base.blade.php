...
<head>
    ...
    <title>Yulita Cakes @yield('title')</title>
    <link rel="shortcut icon" href="{{ secure_asset('logo-putih.jpeg') }}" type="image/x-icon">
...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color: #F4B7BE;">
    <div class="wrapper">
        @include('components.navbar')
        @include('components.sidebar')
        <div class="content-wrapper mt-2" style="background-color: #F4B7BE;">
            @yield('content')
        </div>
    ...
    <script src="{{ secure_asset('assets/plugins/adminlte/js/demo.js') }}"></script>
    <script src="{{ secure_asset('js/keluar.js') }}"></script>
    @yield('script')
</body>
